...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/mnleg">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/mnleg/styles.bundle.css`
      * `scripts`: `news/projects/all/mnleg/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/mnleg/",
      "url": "http://static.startribune.com/news/projects-staging/all/mnleg/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/mnleg/",
      "url": "http://static.startribune.com/news/projects/all/mnleg/"
    }
  }
}
```
